...
joblib.dump(model, workdir + '//MDG160K_SVR_best_model.pkl')
...
c.to_csv(workdir + '//MDG160K_SVR_C_%s_result.csv' % C_param)
...
g.savefig(workdir+ '//201109_SVR_C_%s.png' % C_param, dpi=300)
