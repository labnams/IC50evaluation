...
joblib.dump(rf, workdir + '//MDG160K_RF_best_model.pkl') 
...
c.to_csv(workdir + '//MDG160K_RF_%s_result.csv' % n_esti)
...
g.savefig(workdir+ '//201109_MDG160K_RF_%s.png' % n_esti, dpi=300)
